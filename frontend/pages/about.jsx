  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "left", marginTop: "20px" }}>
        <h2>Developer</h2>
        <p>
          <strong>Divyansh Jindal</strong>
        </p>
        <p>
          Email:{" "}
          <a href="mailto:b24121@students.iitmandi.ac.in">
            b24121@students.iitmandi.ac.in
          </a>
        </p>
      ...
      <div style={{ textAlign: "left", marginTop: "20px" }}>
        ...
        <p>
          <strong>Aryan Singh</strong>
        </p>
        <p>
          Email:{" "}
          <a href="mailto:technical_secretary@students.iitmandi.ac.in">
            technical_secretary@students.iitmandi.ac.in
          </a>
        </p>
        <p>Phone: +91 63930 51440</p>
      </div>
      ...
      <div style={{ marginTop: "20px", fontSize: "1em", opacity: 0.9 }}>
        <h2
          style={{ fontSize: "1.1em", fontWeight: "500", marginBottom: "5px" }}
        >
          Contributors
        </h2>
        <p style={{ margin: "0", fontSize: "0.85em", lineHeight: "1.4" }}>
          <span style={{ fontWeight: "600" }}>Dhairya Sharma</span> -
          <a href="mailto:b24241@students.iitmandi.ac.in">
            {" "}
            b24241@students.iitmandi.ac.in
          </a>
          <br />
          <span style={{ fontWeight: "600" }}>Ojasvi Jain</span> -
          <a href="mailto:b24208@students.iitmandi.ac.in">
            {" "}
            b24208@students.iitmandi.ac.in
          </a>
        </p>
      </div>
    </div>
